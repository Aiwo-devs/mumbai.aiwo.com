...
export type BookingStep = 'SELECT_SLOT' | 'PATIENT_DETAILS' | 'SUMMARY';
...
export function bookingReducer(state: BookingState, action: BookingAction): BookingState {
  switch (action.type) {
    ...
    case 'TOGGLE_ONLINE':
      return { ...state, isOnline: action.payload, slot: null };
    case 'SELECT_SLOT':
      return { ...state, slot: action.payload, step: 'PATIENT_DETAILS' };
    case 'SET_DETAILS':
      return { ...state, patientDetails: { ...state.patientDetails, ...action.payload } };
    case 'NEXT_STEP': {
